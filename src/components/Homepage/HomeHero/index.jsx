...
const HomeHero = () => {
  ...
  return (
   <>
    <motion.div
      ...
      className="!min-h-screen !flex !flex-col md:!flex-row !items-center !justify-between !px-8 !py-16 !bg-white !text-black"
    >
      {/* Left - Hero Text */}
      <motion.div
  ...
  From SEO to web development, we help businesses thrive online.
      ...
      <motion.div
        ...
        className="!bg-gray-100 !p-6 !rounded-2xl !shadow-lg !w-full md:!w-1/3 !mt-8 md:!mt-0"
      >
